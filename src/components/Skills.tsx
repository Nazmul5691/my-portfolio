...
import { SiExpress, SiFirebase, SiGit, SiJavascript, SiMongodb, SiNextdotjs, SiNodedotjs, SiPostgresql, SiPrisma, SiReact, SiRedux, SiTypescript } from 'react-icons/si';
...
const Skills = () => {
    ...
    const techStack = [
        ...
        { name: "Node.js", icon: <SiNodedotjs size={20} />, color: "text-green-400" },
        { name: "Express", icon: <SiExpress size={20} />, color: "text-gray-400" },
        { name: "MongoDB", icon: <SiMongodb size={20} />, color: "text-green-500" },
        { name: "PostgreSQL", icon: <SiPostgresql size={20} />, color: "text-blue-500" },
        { name: "Prisma", icon: <SiPrisma size={20} />, color: "text-white" },
